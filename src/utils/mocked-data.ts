    ...
    reviews: [
      {
        ...
        author: "Олександр М.",
        rating: 5,
        text: "Чудовий сервіс! Швидко замінили мастило, майстри ввічливі та професійні. Обов'язково повернусь ще.",
      ...
      },
      {
        ...
        author: "Марія К.",
        rating: 4,
        text: "Діагностику зробили добре, але довелося зачекати 15 хвилин своєї черги, хоча була записана.",
      ...
      },
      {
        ...
        author: "Ігор В.",
        rating: 5,
        text: "Дуже зручне розташування, привітний персонал. Ціни помірні, відповіли на всі питання щодо ходової.",
        createdAt: new Date(
      ...
      },
      {
        ...
        author: "Денис П.",
        rating: 5,
        text: "Робив ТО перед дальньою поїздкою. Все супер, жодних нарікань, швидко і якісно.",
        createdAt: new Date(
